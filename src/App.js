          ...
          <div className="collapse navbar-collapse flex-row-reverse " id="navbarTogglerDemo02">
            <ul className="navbar-nav ">
              <li className="nav-item me-3 ms-3">
                <a className="nav-link " aria-current="page" target="_blank" rel=" noreferrer" href="https://github.com/FinalYearProject22/academic-report">
              ...
              <li className="nav-item me-3 ms-3">
                <a className="nav-link " href="#dgs" target="_blank" rel=" noreferrer">
              ...
              <li className="nav-item me-3 ms-3">
                <a className="nav-link " href="ghfd" >
