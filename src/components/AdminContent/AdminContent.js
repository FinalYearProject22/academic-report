                ...
                <div className="container text-light">
                    <div className="row gy-4">
                       <div className="card border-0 col-lg-4 text-white">
                            <img className="card-img rounded-3 " src="http://www.freeimageslive.com/galleries/backdrops/natural/pics/abstract_water.jpg" alt="Card"></img>
                        ...
                        <div className="card border-0 col-lg-4 text-white">
                            <img className="card-img img-fluid rounded-3 " src="http://www.freeimageslive.com/galleries/backdrops/natural/pics/abstract_water.jpg" alt="Card"></img>
                            <div className="card-img-overlay ">
